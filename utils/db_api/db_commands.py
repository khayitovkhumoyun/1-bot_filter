...
class Database:
    ...
    async def add_user(self, full_name, username, telegram_id, phone_number,email ):
        sql = "INSERT INTO products_user (full_name, username, tg_id,phone,email) VALUES($1, $2, $3,$4,$5) returning *"
        return await self.execute(sql, full_name, username, telegram_id, phone_number,email,fetchrow=True)
    ...
    async def get_user(self, telegram_id):
        sql = f"SELECT * FROM user_data WHERE tg_id={telegram_id}"
        return await self.execute(sql, fetch=True)
